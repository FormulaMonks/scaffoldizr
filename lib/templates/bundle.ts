...
import scriptsRun from "./scripts/run.sh" with { type: "text/plain" };
import scriptsUpdate from "./scripts/update.sh" with { type: "text/plain" };
...
const templatesMap = new Map([
    ...
    [
        "templates/relationships/multiple-component.hbs",
